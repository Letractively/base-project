...
public abstract class DatePicker extends TextBox implements KeyboardListener {
  ...
  /*
   * show Abstract method to be implemented by all the sub classes. This tells the app how to show the date picker
   */
  public abstract void show();

  /*
   * hide Abstract method to be implemented by all the sub classes. The tells what to do when the calendar needs to be hidden
   */
  public abstract void hide();

  /*
   * redrawCalendar Abstract method to define what to do in case the user traverses the month or year
   */
