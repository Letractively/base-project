...
public class CacheProvider implements org.hibernate.cache.CacheProvider {
  ...
  public void start(Properties properties) throws CacheException {
    if (manager != null) {
      Logger.log("Attempt to restart an already started EhCacheProvider. Use sessionFactory.close() " + " between repeated calls to buildSessionFactory. Using previously created EhCacheProvider."
  ...
  public static String getEhcacheXMLString() {
    return "<ehcache><diskStore path=\"/tmp/sometests.com" + System.currentTimeMillis() + "\"/>"
        + "<defaultCache maxElementsInMemory=\"65536\" eternal=\"false\" overflowToDisk=\"false\" timeToIdleSeconds=\"7200\" timeToLiveSeconds=\"7200\" diskPersistent=\"false\" diskExpiryThreadIntervalSeconds=\"120\"/>" + "</ehcache>";
  }
